        ...
        <dl>
            ...
            <dd class="clearfix">
                ...
                <div class="control-holder">
                    <img runat="server" src="~/App_Themes/trafilm/img/icon-user-name.png" alt="User name icon" />
            ...
            <dd class="clearfix">
                ...
                <div class="control-holder">
                    <img id="Img2" runat="server" src="~/App_Themes/trafilm/img/icon-mail-activation.png" alt="Password icon" />
            ...
            <dd class="clearfix">
                ...
                <div class="control-holder">
                    <img runat="server" src="~/App_Themes/trafilm/img/icon-pwd.png" alt="Password icon" />
            ...
            <dd class="clearfix">
                ...
                <div class="control-holder">
                    <img runat="server" src="~/App_Themes/trafilm/img/icon-timezone.png" alt="Password icon" />
