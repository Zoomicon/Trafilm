        ...
        <div class="discussion-form input-form">
            <dl>
                ...
                <dd class="editor-height">
                    ...
                    <mono:CustomRadEditor Width="100%" ID="radReply" EditModes="Design" StripFormattingOptions="AllExceptNewLines" runat="server" ToolBarMode="ShowOnFocus" ContentAreaMode="Div" ></mono:CustomRadEditor>
                </dd>
                <dd class="legend-no-margin margins">
                    <asp:Label ID="labApprovalNote" runat="server" CssClass="approval-font" ></asp:Label>
                </dd>
                <dd class="my_checkbox margins">
