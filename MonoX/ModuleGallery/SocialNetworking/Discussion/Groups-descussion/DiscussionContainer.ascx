...
<%@ Register TagPrefix="MonoX" TagName="DiscussionBoard" Src="~/MonoX/ModuleGallery/SocialNetworking/Discussion/Groups-descussion/DiscussionBoard.ascx" %>
<%@ Register TagPrefix="MonoX" TagName="DiscussionTopic" Src="~/MonoX/ModuleGallery/SocialNetworking/Discussion/Groups-descussion/DiscussionTopics.ascx" %>  
<%@ Register TagPrefix="MonoX" TagName="DiscussionMessages" Src="~/MonoX/ModuleGallery/SocialNetworking/Discussion/Groups-descussion/DiscussionMessages.ascx" %>  
