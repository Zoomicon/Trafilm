...
<asp:Panel runat="server" ID="pnlContainer">
    ...
    <dl>    
        ...
        <dd>
            <asp:Label ID="lblUpload" AssociatedControlID="ctlUpload" width="300" runat="server"></asp:Label>
            <MonoX:SilverlightUpload runat="server" ID="ctlUpload" width="300" EnableFileGallery="false"  />
        </dd>
        <dd>
    ...
    <!--TRAFILM--><MonoX:StyledButton id="btnSend" runat="server" CausesValidation="true" ValidationGroup="MessageCreateValidation" OnClick="btnSend_Click" CssClass="styled-button-trafilm_green"  />
