    ...
    <div class="popupBox">
        ...
        <div class="footer">
            <asp:PlaceHolder id="plhActions" Runat="server">
                <!--TRAFILM--><asp:Button id="btnSave" runat="server" CausesValidation="true" ValidationGroup="Modification" CssClass="AdminButton styled-button-trafilm_green" OnClientClick="javascript:CloseWindow()" />
            </asp:PlaceHolder>
