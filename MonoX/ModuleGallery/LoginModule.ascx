                ...
                <dl>
                    <dd class="clearfix">
                        ...
                        <div class="control-holder">
                            <!--TRAFILM<img runat="server" src="~/App_Themes/Default/img/icon-user-name.png" alt="User name icon" />-->
                            <!--TRAFILM--><img runat="server" src="~/App_Themes/trafilm/img/icon-user-name.png" alt="User name icon" /><!--/TRAFILM-->
                    ...
                    <dd class="clearfix">
                        ...
                        <div class="control-holder">
                            <!--TRAFILM<img runat="server" src="~/App_Themes/Default/img/icon-pwd.png" alt="Password icon" />-->
                            <!--TRAFILM--><img runat="server" src="~/App_Themes/trafilm/img/icon-pwd.png" alt="Password icon" /><!--/TRAFILM-->
