...
<asp:Content ContentPlaceHolderID="cp" Runat="Server">
    <div class="top-copyright">
        Copyright &#169;2016
        <a href="http://trafilm.net" title="Learn more about the Project">trafilm.net</a>
    </div>
    ...
    <div class="error-bottom-section">
        <div class="container-fluid-large">
            <p><%= Description %></p>
            <h3><%= MonoSoftware.MonoX.Resources.ErrorMessages.ToContinueWorkingWithApplication %> <asp:HyperLink ID="lnkHome" runat="server" NavigateUrl="http://trafilm.net"></asp:HyperLink></h3>
        </div>
    </div>
</asp:Content>
