...
<%-- trafilm: Removed MonoX Demo indicator --%>
<footer>
    <div class="footer-wrapper">
        <div class="footer">
            <ul>               
                <li><span class="copyright"><%= PageResources.PageFooter_Copyright%> &#169;2016 <a href="#"><strong>trafilm</strong></a></span>&nbsp; /&nbsp;    <asp:HyperLink runat="server" ID="lnkPrivacyPolicy" NavigateUrl='<% $Code: MonoSoftware.MonoX.Utilities.LocalizationUtility.RewriteLink(MonoSoftware.MonoX.RewrittenUrlBuilder.GetContentPageUrl(MonoSoftware.MonoX.RewrittenPaths.ContentPage, "PrivacyPolicy").Url) %>'><%= PageResources.PageFooter_PrivacyPolicy %></asp:HyperLink> &nbsp; : &nbsp; <asp:HyperLink runat="server" ID="lnkTermsOfUse" NavigateUrl='<% $Code: MonoSoftware.MonoX.Utilities.LocalizationUtility.RewriteLink(MonoSoftware.MonoX.RewrittenUrlBuilder.GetContentPageUrl(MonoSoftware.MonoX.RewrittenPaths.ContentPage, "TermsOfUse").Url) %>'><%= PageResources.PageFooter_TermsOfUse %></asp:HyperLink></li>
                ...
                <li class="align-right"><a href="https://twitter.com/trafilm" title="visit our twitter account" class="twitter-link"></a></li>
                <li class="align-right"><a href="http://www.facebook.com/trafilm" title="visit our facebook page" class="facebook-link"></a></li>
            </ul>
        </div>   
