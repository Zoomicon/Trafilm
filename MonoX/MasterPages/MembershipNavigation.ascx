    ...
    <asp:PlaceHolder ID="panLoggedInTemplate" runat="server">
        <div class="logged">
            <asp:HyperLink runat="server" ID="lnkProfile">
                ...
                <img runat="server" src="~/App_Themes/trafilm/img/icon-profile.png" alt="Profile" title="visit your profile" class="imgover" />
                <%--/!!!--%>
            </asp:HyperLink>
            <asp:HyperLink runat="server" ID="lnkMessages">
                <%--!!!--%>
                <img runat="server" src="~/App_Themes/trafilm/img/icon-message.png" alt="Messages" class="imgover" />
                <%--/!!!--%>
            </asp:HyperLink>    
